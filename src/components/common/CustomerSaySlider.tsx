...
const data = [
    {
        name: "Long",
        content: "Tôi tên là Long tôi đến từ Đông Anh tôi học tại trường fpoly đang thực tập tại AHT Tech năm nay tôi 24 tuổi tôi rất thích code đặc biệt là code php magento nó làm tôi chán vl:))",
        ...
        <div className='overflow-hidden'>
            ...
            <div className='flex transition-transform duration-500 ease-in-out gap-8' style={{ transform: `translateX(-${currentIndex * (100 / visibleItems)}%)` }}>
                {data.map((item, index) => (
                    <div
                        key={index}
                        className='w-full md:w-[calc((100%_-_64px)/3)] flex-shrink-0'
                    >
                        <CustomerSay
                            star={item.star}
